...
LANGUAGE_PATTERNS = {
    ...
    Language.UR: r'[\u0600-\u06FF]',  # Urdu (uses Arabic script like Persian)
    Language.HI: r'[\u0900-\u097F]',  # Devanagari script (Hindi)
...
TRANSLATIONS = {
    "language_select": {
        ...
        Language.UR: "👋 السلام علیکم! میں {agent_name} کا AI اسسٹنٹ ہوں۔\n\nبراہ کرم اپنی زبان منتخب کریں:",
        Language.HI: "👋 नमस्ते! मैं {agent_name} का AI असिस्टेंट हूं।\n\nकृपया अपनी भाषा चुनें:"
    },
    "welcome": {
        ...
        Language.UR: "👋 بہت خوب! مجھے دبئی میں شاندار مواقع دریافت کرنے میں آپ کی مدد کرنے کی خوشی ہے!\n\n✨ **کیا آپ جانتے ہیں؟**\n• 7-10% کرایہ کی آمدنی (عالمی طور پر 3% کے مقابلے)\n• جائیداد کے منافع پر صفر انکم ٹیکس\n• سالانہ 8-12% قیمت میں اضافہ\n• 2M AED سے گولڈن ویزا کی اہلیت\n\nآئیں میں آپ کو دکھاتا ہوں کہ آپ یہاں اپنی دولت کیسے بڑھا سکتے ہیں! 🚀",
        Language.HI: "👋 बहुत बढ़िया! मुझे दुबई में अद्भुत अवसर खोजने में आपकी मदद करने की खुशी है!\n\n✨ **क्या आप जानते हैं?**\n• 7-10% किराये की उपज (वैश्विक 3% के मुकाबले)\n• संपत्ति के मुनाफे पर शून्य आयकर\n• सालाना 8-12% मूल्य वृद्धि\n• 2M AED से गोल्डन वीज़ा पात्रता\n\nआइए मैं आपको दिखाता हूं कि आप यहां अपनी संपत्ति कैसे बढ़ा सकते हैं! 🚀"
    },
    "hook_roi": {
        ...
        Language.UR: "🏠 مفت ROI تجزیہ حاصل کریں!\n\nدیکھیں کہ دبئی رئیل اسٹیٹ سرمایہ کاری سے آپ کتنا کما سکتے ہیں۔\n\nکیا آپ اپنی ذاتی رپورٹ حاصل کرنا چاہیں گے؟",
        Language.HI: "🏠 मुफ्त ROI विश्लेषण प्राप्त करें!\n\nदेखें कि आप दुबई रियल एस्टेट निवेश से कितना कमा सकते हैं।\n\nक्या आप अपनी व्यक्तिगत रिपोर्ट प्राप्त करना चाहेंगे?"
    },
    "phone_request": {
    ...
    "phone_request_button": {
        ...
        Language.HI: "📱 فون نمبر شیئر کریں"
    },
    "transaction_type": {
        ...
        Language.UR: "🏘️ کیا آپ خریدنا چاہتے ہیں یا کرایہ پر لینا؟",
        Language.HI: "🏘️ क्या आप खरीदना चाहते हैं या किराये पर लेना?"
    },
    "property_type": {
        ...
        Language.RU: "🏢 Какой тип недвижимости?\n\n• Жилая (Квартира, Вилла)\n• Коммерчесkая (Офис, Магазин)",
        Language.UR: "🏢 کس قسم کی جائیداد؟\n\n• رہائشی (اپارٹمنٹ، ولا)\n• کمرشل (دفتر، دکان)",
        Language.HI: "🏢 किस प्रकार की संपत्ति?\n\n• आवासीय (अपार्टमेंट, विला)\n• व्यावसायिक (कार्यालय, दुकान)"
    },
    "budget": {
        ...
        Language.UR: "💰 آپ کا بجٹ کیا ہے؟",
        Language.HI: "💰 आपका बजट क्या है?"
    },
    "payment_method": {
        ...
        Language.UR: "💳 ادائیگی کا طریقہ؟",
        Language.HI: "💳 भुगतान का तरीका?"
    },
    "purpose": {
        ...
        Language.UR: "🎯 اصل مقصد کیا ہے؟\n\n• سرمایہ کاری (کرایہ کی آمدنی)\n• رہائش (ذاتی استعمال)\n• رہائشی ویزا (گولڈن ویزا)",
        Language.HI: "🎯 मुख्य उद्देश्य क्या है?\n\n• निवेश (किराये की आय)\n• रहना (व्यक्तिगत उपयोग)\n• निवास (गोल्डन वीज़ा)"
    },
    "schedule": {
        ...
        Language.UR: "📅 بہترین! آئیں مشاورت کا وقت طے کریں۔\n\nدستیاب اوقات:",
        Language.HI: "📅 बहुत अच्छा! आइए सलाह का समय तय करें।\n\nउपलब्ध स्लॉट:"
    },
    "completed": {
        ...
        Language.UR: "✅ شکریہ! آپ کی مشاورت کا وقت طے ہو گیا۔\n\nہمارے ایجنٹ {agent_name} مقررہ وقت پر آپ سے رابطہ کریں گے۔\n\nجلد ملیں گے! 🏠",
        Language.HI: "✅ धन्यवाद! आपकी सलाह शेड्यूल हो गई।\n\nहमारे एजेंट {agent_name} निर्धारित समय पर आपसे संपर्क करेंगे।\n\nजल्द मिलते हैं! 🏠"
    },
    "ghost_reminder": {
        ...
        Language.UR: "👋 السلام علیکم! میں نے محسوس کیا کہ ہماری بات چیت مکمل نہیں ہوئی۔\n\nکیا آپ کے دبئی رہائش یا رئیل اسٹیٹ سرمایہ کاری کے بارے میں کوئی سوالات ہیں؟",
        Language.HI: "👋 नमस्ते! मैंने देखा कि हमने अपनी बातचीत पूरी नहीं की।\n\nक्या आपके दुबई निवास या रियल एस्टेट निवेश के बारे में कोई सवाल हैं?"
    },
    ...
    "image_error": {
        ...
        Language.UR: "😔 معذرت، تصویر پر کاروائی نہیں ہو سکی۔ براہ کرم ایک واضح تصویر بھیجیں۔",
        Language.HI: "😔 क्षमा करें, छवि प्रोसेस नहीं हो सकी। कृपया एक स्पष्ट फोटो भेजें।"
    }
}
...
BUDGET_OPTIONS = {
    ...
    Language.UR: ["500K سے کم", "500K - 1M", "1M - 2M", "2M - 5M", "5M+"],
    Language.HI: ["500K से कम", "500K - 1M", "1M - 2M", "2M - 5M", "5M+"]
}
    ...
    def _handle_language_select(self, lang: Language, callback_data: Optional[str], lead_updates: Dict, message: Optional[str] = None) -> BrainResponse:
        ...
        # Handle text-based language selection (user types language name or any text)
            ...
            if 'فارسی' in message or 'persian' in message_lower or 'fa' in message_lower:
                ...
                lang = Language.RU
                lead_updates["language"] = lang
            elif 'اردو' in message or 'urdu' in message_lower or 'ur' in message_lower:
                lang = Language.UR
                lead_updates["language"] = lang
            elif 'हिंदी' in message or 'hindi' in message_lower or 'hi' in message_lower:
                lang = Language.HI
                lead_updates["language"] = lang
            ...
            elif re.search(r'[\u0900-\u097F]', message):  # Devanagari script (Hindi)
                lang = Language.HI
                lead_updates["language"] = lang
            elif re.search(r'[\u0600-\u06FF]', message):  # Persian/Arabic/Urdu script detected
                # Default to Persian for now (could add Arabic/Urdu detection heuristics later)
                lang = Language.FA
                lead_updates["language"] = lang
        ...
        name_question = {
            ...
            Language.UR: "آپ سے مل کر خوشی ہوئی! 👋\n\nآپ کا نام کیا ہے؟",
            Language.HI: "आपसे मिलकर खुशी हुई! 👋\n\nआपका नाम क्या है?"
        }
